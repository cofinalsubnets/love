...
static char const runner[] = "(reads(tap(s2cl tests)))";   // the stream shell (core/boot/post.l) drinks the corpus
...
// core/boot/post.l's `cli-line` is this tail entire, spliced with its module: the argv[0] verb
