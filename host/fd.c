// host/fd.c -- love's ports over OS file descriptors: ai_fd_port_vt and the ai_fd_* family
...
// host/main.c's binary and the inle kernel both link it, so what lives here exists once
