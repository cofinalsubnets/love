...
Companions: `l/boot/post.l` (the module), `test/kanren.l` (the gate), `doc/misc/proto/kanren-prove.l`
...
and `l/boot/post.l` reads `subst` through the registry. **The constraint store rides BESIDE it** —
