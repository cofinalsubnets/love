...
the generator -- exactly as `src/mkvec.l` carries its narrative in the love that lays
the assembly.
...
* ~~**dtoa**~~ -- SETTLED the other way: the printer moved into lisp (`love/post.l`), and
