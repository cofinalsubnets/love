...
`l/love.c:6138`'s z-tray comparison is the same array-indexed shape.
...
`make -C bench ccnif` builds inle/hash.c and l/gz.c with every lane
...
Direct per-step timing, not subtraction: `l/love.c` is 68% of the build, and 88% of
