...
(l/quay/paint.c) that turns a cell into pixels off the xterm-256 table, and a
...
- **the console is core**, not host: quay's cb, painter and palette (l/quay/) are
...
- **rung 2 -- rove as the fiction engine.** ✅ LANDED, apps/rove/story.l + design.l,
  ...
  the map, yubn included. THE FACE IS ONE: cli (l/boot/post.l) carries the
