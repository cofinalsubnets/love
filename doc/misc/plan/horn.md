...
`l/boot/p1.l`, and salt, dns, cli and bao all stand on it. There is a `sound0` nif beside it.
...
* **the port vtable is the ring contract, verbatim.** `l/love.h`: *"writen: land up to n bytes
