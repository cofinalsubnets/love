...
if [ $# -gt 0 ]; then files="$*"; else
  files="src/*.c apps/moon/lib/moonlibc/math/am.c apps/moon/lib/moonlibc/string/*.c \
         apps/moon/lib/moonlibc/stdio/*.c apps/moon/lib/moonlibc/fmt/*.c \
         apps/moon/lib/moonlibc/os.c apps/moon/lib/moonlibc/env/*.c apps/moon/lib/moonlibc/proc/*.c"; fi
for f in $files; do
