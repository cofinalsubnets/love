...
CFLAGS="-DSTDC_HEADERS=1 -DHAVE_UNISTD_H=1 -DDIRENT=1 -Icrew/moon/include -I$d/src"
...
# crew/moon/lib/nolibc/ MEMBER BY NEED (src/build.mk says the same thing about love
