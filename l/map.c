...
// the walk-from-nothing entry; hash_at (l/arr.c) is the same walk continued above a live
...
// hosted here reads "not a bare board": mooncc predefines 1 and only i/ passes 0.
