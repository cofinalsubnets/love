...
//
enum q { KMint, KNom, KCharm, KSun, KGem, KTwin, KTrayZ, KTrayR, KTrayC, KTrayO, KString, KChain, KTablet, KCoin, KN };
enum d { DMint, DNom, DGem, DTwin, DBig, DTray, DString, DChain };
#define ai_kind_names "mint nom charm sun gem twin trayz trayr trayc trayo string chain tablet coin"
//
