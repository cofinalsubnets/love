// i/image.c -- file I/O around the stdio-free image codec in snap.c (ai_image_save /
// ai_image_load). that codec rides love_tu, which the i/ boards link with no stdio
