...
// they do not all stand on the same footing. crc32 shadows a/gz.l's gz-crcwalk and
...
// a/gz.l spells is a dependency chain one link per byte, where slicing spends eight
