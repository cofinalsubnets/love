// i/mem.c -- raw slots on a cask: the door between love's values and a byte buffer's own
...
// (a/harp/play.l's pack lays each channel with one call) and what a plane of anything
