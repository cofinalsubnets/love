// i/posix.c -- the POSIX surface, in one place: process (spawn/reap/wait/
...
// on inle the open(2)/close(2) below land in i/sys.c's arms, so the ramfs
