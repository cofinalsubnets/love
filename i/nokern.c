// i/nokern.c -- the null seat: what a link with no kmain.c under it owes itself.
// i/main.c dispatches to the kernel's doors on a negative __ai_osv, so the symbols have
