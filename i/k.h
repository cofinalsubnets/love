...
// Combines the former i/k.h (kernel logging) and free/k_boot.h (the boot
// hand-off struct).
#pragma once
#include "love.h"
...
// the sound card (i/hda.c): probe at boot with one DMA block, and the poll the
...
// the x64 virtualization doors (i/x64/svm.c, i/x64/vmx.c)
