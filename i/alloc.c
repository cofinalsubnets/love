// i/alloc.c -- the runtime's heap over malloc and free, for a seat whose memory already
...
// with no i/fd.c owes the runtime's doors, and having a heap is not having an fd.
#include "love.h"
