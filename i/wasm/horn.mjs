// i/wasm/horn.mjs -- the horn under the loader: love writes PCM to a (horn ..)
// port, the sink taps its accepted frames (i/horn.c ai_horn_tap -> host.c's ring),
...
// usage: node i/wasm/horn.mjs [--love <love.wasm>]
