...
#else
#define EMSCRIPTEN_KEEPALIVE      // moon's lane exports every extern function; the loader is i/wasm/loader.js
#endif
#include <time.h>
#include <stdlib.h>
#include <string.h>
...
// C face refuses and horn.c's own sink keeps the time.
...
// (i/wasm/cells.js) -- a copy, since the cask moves with the heap and the page
...
// the sink taps its accepted frames here (i/horn.c ai_horn_tap); the loader
