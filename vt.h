...
// bodies (vt.c) are laid out contiguously and in enum order in the
// .gwen_data_vt section by vt.ld (host) or the equivalent inline
...
// out in the divide).
// wasm has no flat code address space and supplies its own copy (wasm/inc/vt.h).
