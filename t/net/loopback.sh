#!/bin/sh
# t/net/loopback.sh -- the ain loopback gate (host-only, NOT in the portable
...
# and their teardown.
#
#   sh t/net/loopback.sh <love-binary> [port]
#
...
PORT="${2:-7390}"
AK="a/ain.l"   # prel is baked into the egg -- no -l l/boot/prel.l preload
