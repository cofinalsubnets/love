...
$(ho)/frontseat: t/front/main.c $(R)/l/bare.c $(R)/i/horn.c $(R)/i/hornring.h $(love_h) $(ho)/liblove.a $(ho)/.hostcc $(R)/l/love_data.ld \
    b/lib/egg.h b/lib/post.h b/lib/p1.h b/lib/prel.h b/lib/ev.h
	@echo 'CC	'$@
	@mkdir -p $(dir $@)
	@$(hcc) -D ai_horn_seat=1 -o $@ t/front/main.c $(R)/l/bare.c $(R)/i/horn.c $(ho)/liblove.a $(data_ld)
