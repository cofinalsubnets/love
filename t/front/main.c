// t/front/main.c -- a TEST-ONLY love frontend, and the instrument the io arc
...
// the Makefile builds liblove.a from love.c ONLY and links i/*.c direct --
...
// well as the vtable: i/fd.c has them on a hosted seat and i/fdrow.h on a
