#!/bin/sh
# t/gate/vec.sh -- the INTERRUPT gate.
#
# i/mkvec.l lays the exception and IRQ entry points that used to be
...
if ! have "$qemu"; then
  ...
  fault_report() {
    ...
    # 768M like u/ktest.l: a major takes a contiguous 2x pool beside the old one,
