#!/bin/sh
# t/gate/cpio.sh -- a/cpio/cpio.l + a/cpio/cpiocmd.l against the program they replace.
#
...
# argument t/gate/targz.sh makes, and the reason this gate is separate from the
# laws in t/host/.
#
...
echo "cpio: a/cpio/cpio.l agrees with GNU cpio both ways over newc -- ok"
