#!/bin/sh
# t/gate/rv64.sh -- the rv64 codegen rung end to end: the whole t/cc battery
...
echo "RISCV t/cc battery (mooncc -t rv64 vs native x64, under qemu-riscv64)"
...
# case is the same set, and a program added to t/cc/ has to join both or this gate reads
