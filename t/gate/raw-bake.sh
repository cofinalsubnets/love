#!/bin/sh
# t/gate/raw-bake.sh -- the WAKE half of the gcc-free image cycle. mooncc could
...
# links them PIE, bakes the post-warm image into the binary's OWN .image (i/image.c
...
# corpus as a FILE, stdin closed -- test_host's reason (t/test.mk): the corpus
