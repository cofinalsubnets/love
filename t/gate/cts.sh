#!/bin/sh
# t/gate/cts.sh -- mooncc against an OUTSIDE corpus: c-testsuite's 220 single-file
...
#
# WHY THIS AND NOT MORE t/cc FILES. Every file in t/cc/ was written here, and
