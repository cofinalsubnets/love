#!/bin/sh
# t/gate/playdate.sh -- the Playdate build gate.
#
...
#     second base, diffed word for word (t/gate/pdreloc.l)
#
...
# t/gate/ld32.l takes to read an object back through our own linker's front half
