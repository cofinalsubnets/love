// t/gate/glass.mjs -- the page's half of the console's grid, asked without a page.
// i/wasm/glass.mjs turns a canvas box into real pixels and the zoom a glyph pixel gets,
...
// usage: node t/gate/glass.mjs
import { glass } from '../../i/wasm/glass.mjs';
...
console.log(bad ? `FAIL glass: ${bad} of the grid's laws` : '  glass: ok -- i/wasm/glass.mjs without a page');
