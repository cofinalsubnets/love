...
(assert
  ...
  (= 1 (len "\n"))           (= "\n" (string (X 10 0)))
  (= 1 (len "\t"))           (= "\t" (string (X 9 0)))
  (= 1 (len "\r"))           (= "\r" (string (X 13 0)))
  (= 1 (len "\0"))           (= "\0" (string (X 0 0)))
  ; \xHH: two hex digits.
  (= 1 (len "\x00"))         (= "\x00" (string (X 0 0)))
  (= 1 (len "\x41"))         (= "\x41" (string (X 65 0)))
  (= 1 (len "\xff"))         (= "\xff" (string (X 255 0)))
  (= "\x41" "A")             (= "\x0a" "\n")
  (= "\xAB" "\xab")          ; mixed case
  ...
  (= 3 (len "a\tb"))         (= "a\tb" (string (X 97 (X 9  (X 98 0)))))
  (= 3 (len "a\rb"))         (= "a\rb" (string (X 97 (X 13 (X 98 0)))))
  (= 3 (len "a\0b"))         (= "a\0b" (string (X 97 (X 0  (X 98 0)))))
  (= 3 (len "a\x42b"))       (= "a\x42b" (string (X 97 (X 66 (X 98 0))))))
