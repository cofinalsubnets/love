...
hostnif_tests = test/host/gcpause.l test/host/deepeq.l test/host/wharf.l test/host/cb.l test/host/manifest.l test/host/rune.l test/host/pty.l test/host/loader.l test/host/rdiff.l test/host/run.l test/host/luxui.l test/host/sh.l test/host/berth.l test/host/overlay.l test/host/bake.l test/host/rove.l test/host/tty.l test/host/lapiz.l test/host/papel.l test/host/kiosko.l test/host/serve.l test/host/sbhttp.l test/host/salt.l test/host/libra.l test/host/clay.l test/host/tls.l test/host/tlsc.l test/host/gz.l test/host/gzc.l test/host/story.l test/host/design.l test/host/slop.l test/host/lupa.l test/host/mc.l test/host/helm.l test/host/wget.l test/host/cook.l test/host/x11.l
