#!/bin/sh
# test/gate/elf32.sh -- holo's ELF32 executable writer (love/holo/elf.l elf32-at), judged by
...
for tgt in thumb1 thumb2; do
  { cat love/holo/holo.l "love/holo/$tgt.l" love/holo/elf.l test/gate/elf32.l
