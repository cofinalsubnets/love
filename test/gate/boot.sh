...
case $gate in
  mps2)      $mk -C inle/mps2 || fail "mps2 build" ;;
  mps2_t1)   $mk -C inle/mps2 mps2t1 || fail "mps2t1 build" ;;
  mps2_wake) $mk -C inle/mps2 img ../../out/mps2/waker.elf || fail "mps2 waker build"
  ...
  nucleo446_smoke) $mk -C inle/nucleo446 smoke || fail "nucleo446 smoke build" ;;
  virt)      $mk -C inle/virt || fail "virt build" ;;
esac
