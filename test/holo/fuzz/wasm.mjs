// the other half of test/holo/fuzz/wasm.l: instantiate what love laid and hold every export
...
// usage: node test/holo/fuzz/wasm.mjs [out/.wasmfuzz.wasm] [out/.wasmfuzz.json]
