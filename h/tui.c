...
int gputc(struct g *f, int c)       { return putchar(c), c; }
int gflush(struct g *f)             { return fflush(stdout), 0; }
int ggetc(struct g *f)              { return -1; }   // editor is the source
int gungetc(struct g *f, int c)     { return c; }
int geof(struct g *f)               { return 1; }
