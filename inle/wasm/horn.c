// wasm's sound card, which is the page: love.h's k_horn_* on this seat, what inle/hda.c is
// on x64. no controller to walk and no ring to lay here -- the worker (inle/wasm/cpu.mjs)
