...
// is inle/wasm/arch.c's five hypercalls wearing linux's numbers, and inle/wasm/horn.c's four
...
async function boot(msg) {
  ...
  // (inle/wasm/arch.c) -- the same sum here says where to blit from. the two carves must
