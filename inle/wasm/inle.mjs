// inle/wasm/inle.mjs -- the serial terminal for love-wasm.wasm under node: the machine
...
//   usage: node inle/wasm/inle.mjs [--fb WxH --dump screen.ppm] [--lift /in/machine:out/here]
