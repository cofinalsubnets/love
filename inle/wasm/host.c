...
#else
#define EMSCRIPTEN_KEEPALIVE      // moon's lane exports every extern function; the loader is inle/wasm/loader.js
#endif
#include <time.h>
#include <stdlib.h>
#include <string.h>
...
// (inle/wasm/cells.js) -- a copy, since the cask moves with the heap and the page
