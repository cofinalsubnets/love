// inle/src.c -- the archives the artifact carries: its own source, and moonlibc per ISA
#include "love.h"
#include <string.h>
...
// object names inle/noblob.c instead, so the length alone says whether anything is aboard.
