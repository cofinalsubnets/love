// inle/uefi/loader.c -- our own BOOTX64.EFI / BOOTAA64.EFI: the bring-up a bootloader used
...
// the k_boot shape (inle/k.h), kept in step by hand: this file compiles freestanding,
