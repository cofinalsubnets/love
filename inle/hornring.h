// inle/hornring.h -- the PCM ring between a horn that PUSHES and a device that PULLS.
//
// inle/horn.c hands a seat interleaved stereo s16 whenever love writes, and a card asks for
...
// the ring is full. short is not a loss: inle/horn.c keeps the residue and parks, so the
