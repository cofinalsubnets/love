...
// the null seat is inle/nokern.c's and the carried blobs inle/noblob.c's -- love0 has no
...
// love0 has no moonlibc either, so __ai_osv is love/love.c's weak one, which reads 0.
