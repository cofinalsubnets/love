// inle/noblob.c -- what inle/src.c's carried blobs mean in a link that carries none.
// out/src.o (tools/mksrc.l) lays the source archive and out/moonlibc.o (tools/mkrt.l)
