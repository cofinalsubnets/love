...
(* !(3 = 4) *)
Theorem gen_50 : (negb (Z.eqb 3 4)) = true.  Proof. vm_compute. reflexivity. Qed.
(* ('x < "a") *)
...
(* !(1 < "a") *)
Theorem gen_54 : (negb (Z.ltb (vband Vz) (vband Vstr))) = true.  Proof. vm_compute. reflexivity. Qed.
(* ('(0) < (hash 1 10)) *)
Theorem gen_55 : (Z.ltb (vband Vpair) (vband Vmap)) = true.  Proof. vm_compute. reflexivity. Qed.
(* ("abcd" = "ab" + "cd") *)
Theorem gen_56 : (leqb [97;98;99;100] ([97;98] ++ [99;100])) = true.  Proof. vm_compute. reflexivity. Qed.
(* ('(1 2 3 4) = '(1 2) + '(3 4)) *)
Theorem gen_57 : (leqb [1;2;3;4] ([1;2] ++ [3;4])) = true.  Proof. vm_compute. reflexivity. Qed.
(* ('(5 1 2) = 5 + '(1 2)) *)
Theorem gen_58 : (leqb [5;1;2] (5 :: [1;2])) = true.  Proof. vm_compute. reflexivity. Qed.
(* ("ababab" = "ab" * 3) *)
Theorem gen_59 : (leqb [97;98;97;98;97;98] (srep (Z.to_nat 3) [97;98])) = true.  Proof. vm_compute. reflexivity. Qed.
(* ('(1 2 1 2) = '(1 2) * 2) *)
Theorem gen_60 : (leqb [1;2;1;2] (srep (Z.to_nat 2) [1;2])) = true.  Proof. vm_compute. reflexivity. Qed.
(* !("ab" * -3) *)
Theorem gen_61 : (Z.leb (asum (srep (Z.to_nat (-3)) [97;98])) 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* !('(1 2) * 0) *)
Theorem gen_62 : (Z.leb (asum (srep (Z.to_nat 0) [1;2])) 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* ("" = "ab" * 0) *)
Theorem gen_63 : (leqb [] (srep (Z.to_nat 0) [97;98])) = true.  Proof. vm_compute. reflexivity. Qed.
(* (5 = (abs -5)) *)
Theorem gen_64 : (Z.eqb 5 (Z.abs (-5))) = true.  Proof. vm_compute. reflexivity. Qed.
(* (charm? (abs -5)) *)
Theorem gen_65 : (fixp Vz) = true.  Proof. vm_compute. reflexivity. Qed.
(* (1024 = (10 2)) *)
Theorem gen_66 : (Z.eqb 1024 (appZ 10 2)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (21 = (gcd 1071 462)) *)
Theorem gen_67 : (Z.eqb 21 (Z.gcd 1071 462)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (1024 = (10 2)) *)
Theorem gen_68 : (Z.eqb 1024 (appZ 10 2)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (27 = (3 3)) *)
Theorem gen_69 : (Z.eqb 27 (appZ 3 3)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (7625597484987 = (3 3 3)) *)
Theorem gen_70 : (Z.eqb 7625597484987 (appZ (appZ 3 3) 3)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (16 = (2 2 2)) *)
Theorem gen_71 : (Z.eqb 16 (appZ (appZ 2 2) 2)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (65536 = (2 2 2 2)) *)
Theorem gen_72 : (Z.eqb 65536 (appZ (appZ (appZ 2 2) 2) 2)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (-8 = (3 -2)) *)
Theorem gen_73 : (Z.eqb (-8) (appZ 3 (-2))) = true.  Proof. vm_compute. reflexivity. Qed.
(* !(twin? 5) *)
...
Theorem gen_77 : (leqb [11;22;33] (vaddt [1;2;3] [10;20;30])) = true.  Proof. vm_compute. reflexivity. Qed.
...
(* ((tuple 0 1 2) = (iota 3)) *)
Theorem gen_81 : (leqb [0;1;2] (iotaZ 3)) = true.  Proof. vm_compute. reflexivity. Qed.
(* !(iota 0) *)
Theorem gen_82 : (Z.leb (asum (iotaZ 0)) 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* !(iota -1) *)
Theorem gen_83 : (Z.leb (asum (iotaZ (-1))) 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* (4950 = (net (iota 100))) *)
Theorem gen_84 : (Z.eqb 4950 (asum (iotaZ 100))) = true.  Proof. vm_compute. reflexivity. Qed.
(* ((tuple 3 5) = (// (tuple 7 11) 2)) *)
Theorem gen_85 : (leqb [3;5] (vquot 2 [7;11])) = true.  Proof. vm_compute. reflexivity. Qed.
(* !((tuple 1 2 3) + (tuple 1 2)) *)
Theorem gen_86 : (Z.leb (asum (vaddt [1;2;3] [1;2])) 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* !(two? 'x) *)
Theorem gen_87 : (negb (chainp Vsym)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (name? 'x) *)
Theorem gen_88 : (namep Vsym) = true.  Proof. vm_compute. reflexivity. Qed.
(* (3 = (tally "abc")) *)
Theorem gen_89 : (Z.eqb 3 (Z.of_nat (length [97;98;99]))) = true.  Proof. vm_compute. reflexivity. Qed.
(* (5 = (abs -5)) *)
Theorem gen_90 : (Z.eqb 5 (Z.abs (-5))) = true.  Proof. vm_compute. reflexivity. Qed.
(* ("abcd" = (+ "ab" "cd")) *)
Theorem gen_91 : (leqb [97;98;99;100] ([97;98] ++ [99;100])) = true.  Proof. vm_compute. reflexivity. Qed.
(* !(book? 5) *)
Theorem gen_92 : (negb (tabp Vz)) = true.  Proof. vm_compute. reflexivity. Qed.
(* !0 *)
Theorem gen_93 : (Z.leb 0 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* !"" *)
Theorem gen_94 : (Z.leb (asum []) 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* !(iota 0) *)
Theorem gen_95 : (Z.leb (asum (iotaZ 0)) 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* (nil? 0) *)
Theorem gen_96 : (Z.leb 0 0) = true.  Proof. vm_compute. reflexivity. Qed.
(* (0 = (tally (iota 0))) *)
Theorem gen_97 : (Z.eqb 0 (Z.of_nat (length (iotaZ 0)))) = true.  Proof. vm_compute. reflexivity. Qed.
(* (book? (hash 0)) *)
Theorem gen_98 : (tabp Vmap) = true.  Proof. vm_compute. reflexivity. Qed.
(* (5 = (tally "hello")) *)
Theorem gen_99 : (Z.eqb 5 (Z.of_nat (length [104;101;108;108;111]))) = true.  Proof. vm_compute. reflexivity. Qed.
(* !!5 *)
Theorem gen_100 : (negb (Z.leb 5 0)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (nom? 'ab') *)
Theorem gen_101 : (nomp Vsym) = true.  Proof. vm_compute. reflexivity. Qed.
(* (3 = 1 + 2) *)
...
(* (3 = abs -3) *)
Theorem gen_104 : (Z.eqb 3 (Z.abs (-3))) = true.  Proof. vm_compute. reflexivity. Qed.
(* (66 = (2 + 3 4)) *)
Theorem gen_105 : (Z.eqb 66 (Z.add 2 (appZ 3 4))) = true.  Proof. vm_compute. reflexivity. Qed.
(* (6 = +'(1 2 3)) *)
Theorem gen_106 : (Z.eqb 6 (asum [1;2;3])) = true.  Proof. vm_compute. reflexivity. Qed.
(* (-1 = +'(-2 1)) *)
Theorem gen_107 : (Z.eqb (-1) (asum [(-2);1])) = true.  Proof. vm_compute. reflexivity. Qed.
(* (24 = *'(1 2 3 4)) *)
Theorem gen_108 : (Z.eqb 24 (aprod [1;2;3;4])) = true.  Proof. vm_compute. reflexivity. Qed.
(* (5 = |-5) *)
Theorem gen_109 : (Z.eqb 5 (Z.abs (-5))) = true.  Proof. vm_compute. reflexivity. Qed.
(* (3 = (+ 1 2)) *)
Theorem gen_110 : (Z.eqb 3 (Z.add 1 2)) = true.  Proof. vm_compute. reflexivity. Qed.
(* (20 = ((hash 1 10 2 20) -> 2 0)) *)
Theorem gen_111 : (Z.eqb 20 (hget [(1, 10);(2, 20)] 2 0)) = true.  Proof. vm_compute. reflexivity. Qed.

(* 111 theorems generated from 614 asserts seen *)
