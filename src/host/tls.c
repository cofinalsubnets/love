// src/host/tls.c -- the C twins of src/apps/tls's two ciphers, auto-globbed + AiNif-
...
//
// these are twins, not replacements: src/apps/tls/chacha.l and src/apps/tls/poly1305.l
...
// src/apps/tls/bench.l times both, and says whose binary the number belongs to.
#include "love.h"
#include <stdint.h>
#include <string.h>
