// src/port/wasm/cells.js -- a quay screen as html: the page's painter, the pure half.
...
// colours are the same xterm256 table src/core/quay/paint.c spends and the glyphs the
...
function cellsFace(pal, unfold) {
  ...
  for (let i = 0; i < 256; i++) {
    ...
    // berth's rule (src/apps/berth/limn.l): ascii as itself, else the unfold, else '?';
