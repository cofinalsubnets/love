...
// src/mem.c -- 8-byte word slots on a cask, low 4 bytes live: the flat solver's state
// (crew/sat/flat.l), where the byte-at-a-time accessors cost 4 dispatches per read.
