// src/posix.c -- the POSIX surface, in one place: process (spawn/reap/wait/
...
//                   reads past ns: the kernel's own stat (src/kmain.c) answers the
