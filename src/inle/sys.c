// src/inle/sys.c -- inle's syscall door, and the whole of it. nolibc's 76 sys/* members reach
...
long __ai_inle(long n, long a, long b, long c, long d, long e, long f) {
 ...
 switch (n) {
  ...
  // one clock, the wall: ai_clock's body is clock_gettime now (src/host/posix.c),
